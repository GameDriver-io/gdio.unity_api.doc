# CoApiClient.ClickObjectEx method
...
```csharp
public IEnumerator<bool> ClickObjectEx(MouseButtons buttonId, string hierarchyPath, 
    ulong clickFrameCount, KeyCode[] keys = null, ulong keysNumberOfFrames = 5, 
