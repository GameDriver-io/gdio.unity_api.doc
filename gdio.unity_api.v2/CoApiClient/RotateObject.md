# CoApiClient.RotateObject method (1 of 4)
...
```csharp
public IEnumerator<bool> RotateObject(string hierarchyPath, Quaternion quaternion, 
...
# CoApiClient.RotateObject method (2 of 4)
...
```csharp
public IEnumerator<bool> RotateObject(string hierarchyPath, Vector3 eulers, 
...
# CoApiClient.RotateObject method (3 of 4)

Rotate an object defined by the HierarchyPath and rotated by the axis and angle, relative to the Space

```csharp
public IEnumerator<bool> RotateObject(string hierarchyPath, Vector3 axis, float angle, 
    Space relativeTo = Space.Self, bool waitForObject = true, int timeout = 60)
```
...
# CoApiClient.RotateObject method (4 of 4)

Rotate an object defined by the HierarchyPath and rotated by the x, y, and z angles relative to the Space

```csharp
public IEnumerator<bool> RotateObject(string hierarchyPath, float xAngle, float yAngle, 
    float zAngle, Space relativeTo = Space.Self, bool waitForObject = true, int timeout = 60)
```
