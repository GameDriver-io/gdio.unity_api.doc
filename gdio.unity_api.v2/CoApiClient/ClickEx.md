# CoApiClient.ClickEx method (1 of 2)
...
```csharp
public IEnumerator<bool> ClickEx(MouseButtons buttonId, Vector2 position, ulong clickFrameCount, 
...
# CoApiClient.ClickEx method (2 of 2)
...
```csharp
public IEnumerator<bool> ClickEx(MouseButtons buttonId, float x, float y, ulong clickFrameCount, 
    KeyCode[] keys = null, ulong keysNumberOfFrames = 5, KeyCode[] modifiers = null, 
    ulong modifiersNumberOfFrames = 3, int delayAfterModifiersMsec = 500, int timeout = 30)
```
